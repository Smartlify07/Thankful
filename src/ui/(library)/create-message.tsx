...
const CreateMessage = forwardRef<HTMLDivElement, CreateMessageProps>(
  function CreateMessage(props: CreateMessageProps, ref) {
    const { toggleModal, isModalOpen, user_id } = props;
